...
public class Constants {
    ...
    public static final int STATUS_MASSAGE_BUTTON_Y = 50;
    public static final int STATUS_MASSAGE_BUTTON_WIDTH = 150;
    ...
    public static final String ABOUT_TEXT = "This application is intended to be an automated system for sending Whatsapp messages using SELENIUM," + "\n"
     + " as a practical part of the first degree studies in computer science" + "\n"
     + "Developed by: Alexey Teverovsky, Kesem Khalis, Elon Siboni, Shimon Digilov." + "\n"
